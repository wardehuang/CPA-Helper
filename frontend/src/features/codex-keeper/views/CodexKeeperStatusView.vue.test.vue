...
const showDisabledSectionContent = ref(true)
const showNormalSectionContent = ref(true)
      ...
      <div class="status-toolbar">
        <div class="toolbar-heading">
          ...
          <div class="toolbar-actions">
            ...
            <NButton quaternary size="small" @click="showFilters = !showFilters">
              <template #icon>
                <NIcon :component="showFilters ? ChevronUp : ChevronDown" />
              </template>
            </NButton>
          </div>
        </div>
        <NCollapseTransition :show="showFilters">
      ...
      <div v-if="isTableView" class="account-sections">
        ...
        <section v-if="showDisabledSection" class="account-section">
          <div class="account-section-header">
            <div class="account-section-title-group">
              ...
              <span class="account-section-subtitle">
            ...
            <div class="account-section-actions">
              ...
              <NButton quaternary size="small" @click="showDisabledSectionContent = !showDisabledSectionContent">
                <template #icon>
                  <NIcon :component="showDisabledSectionContent ? ChevronUp : ChevronDown" />
                </template>
              </NButton>
            </div>
          </div>
        ...
        <section v-if="showNormalSection" class="account-section">
          <div class="account-section-header">
            ...
            <div class="account-section-actions">
              <NButton quaternary size="small" @click="showNormalSectionContent = !showNormalSectionContent">
                <template #icon>
                  <NIcon :component="showNormalSectionContent ? ChevronUp : ChevronDown" />
                </template>
              </NButton>
            </div>
          </div>
