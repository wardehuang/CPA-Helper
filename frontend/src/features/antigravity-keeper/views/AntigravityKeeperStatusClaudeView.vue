...
function quotaWindowItems(account: AntigravityKeeperAccount): QuotaWindowItem[] {
  ...
  return [{
      ...
      remainingPercent: nullableRemainingQuotaPercent(account.primary_used_percent),
...
function quotaSortRemainingPercent(account: AntigravityKeeperAccount, key: AccountSortKey): number | null {
  return shouldShowQuotaWindow(account) ? nullableRemainingQuotaPercent(account.primary_used_percent) : null
}
